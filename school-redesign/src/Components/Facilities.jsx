  ...
  return (
    <section id="facilities" className="py-24 px-6 bg-ink/[0.03]">
      <div className="max-w-6xl mx-auto">
        ...
        <Reveal y={24} className="max-w-xl mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {facilities.map((f, i) => (
            <Reveal key={f.n} y={30} delay={i * 0.12}>
              <div className="group relative overflow-hidden rounded-2xl h-80 transition-all duration-300 hover:shadow-2xl">
                {/* Background image */}
                <img
                  src={f.image}
                  alt={f.title}
